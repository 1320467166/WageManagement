...
public class SessionUtil {
	 ...
	 * @return
	 */
	public static Staff getLoginedStaff(){
		HttpSession session = getSession();
		if(session != null){
			Object attribute = session.getAttribute(SessionConstant.SESSION_STAFF_LOGIN_KEY);
			return attribute == null ? null : (Staff) attribute;
		}
		return null;
	}
