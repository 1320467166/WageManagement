        ...
        <main class="lyear-layout-content">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header"><h4>编辑考勤</h4></div>
                            <div class="card-body">
                                <form action="add" id="department-add-form" method="post" class="row">
                                    <input type="hidden" name="id" value="${attendance.id}">
                                    <div class="input-group m-b-10">
                                        <span class="input-group-addon">员工信息</span>
                                        <input type="text"  class="form-control" readonly="readonly" disabled="disabled" value="${attendance.jobNumber}-${attendance.staff.name}-${attendance.department.name}"/>
                                    </div>

                                    <div class="input-group m-b-10">
                                        <span class="input-group-addon">月份</span>
                                        <input type="text" class="form-control" readonly="readonly" disabled="disabled" value="${attendance.year}-${attendance.monthOfDay}"/>
                                    </div>

                                    <div class="input-group m-b-10">
                                        <span class="input-group-addon">病假天数</span>
                                        <input type="number" id="daysSick" name="daysSick" value="${attendance.daysSick}"
                                    ...
                                    <div class="input-group m-b-10">
                                        ...
                                        <input type="number" id="personalLeaveDays" name="personalLeaveDays" value="${attendance.personalLeaveDays}"
                                               class="form-control required" oninput="if (value<0)value=0"
                                    ...
                                    <div class="input-group m-b-10">
                                        ...
                                        <input type="number" id="overtimeHours" name="overtimeHours" value="${attendance.overtimeHours}"
                                               class="form-control required" oninput="if (value<0)value=0"
                                    ...
                                    <div class="input-group m-b-10">
                                        ...
                                        <input type="number" id="overtimeOnWeekends" name="overtimeOnWeekends" value="${attendance.overtimeOnWeekends}"
                                               class="form-control required" oninput="if (value<0)value=0"
                                    ...
                                    <div class="input-group m-b-10">
                                        ...
                                        <input type="number" id="holidayOvertimeHours" name="holidayOvertimeHours" value="${attendance.holidayOvertimeHours}"
                                               class="form-control required" oninput="if (value<0)value=0"
                                    ...
                                    <div class="input-group m-b-10">
                                        ...
                                        <input type="number" id="lateNumber" name="lateNumber" value="${attendance.lateNumber}"
                                               class="form-control required" oninput="if (value<0)value=0"
                                    ...
                                    <div class="input-group m-b-10">
                                        ...
                                        <input type="number" id="leaveEarlyTimes" name="leaveEarlyTimes" value="${attendance.leaveEarlyTimes}"
                                               class="form-control required" oninput="if (value<0)value=0"
                                    ...
                                    <div class="input-group m-b-10">
                                        ...
                                        <input type="number" id="absenceDays" name="absenceDays" value="${attendance.absenceDays}"
                                               class="form-control required" oninput="if (value<0)value=0"
                                    ...
                                    <div class="input-group m-b-10">
                                        ...
                                        <input type="number" id="travelDays" name="travelDays" value="${attendance.travelDays}"
                                               class="form-control required" oninput="if (value<0)value=0"
                                               onkeyup="aDecimal(this)"  placeholder="请填写事假天数" tips="请填写事假天数"/>
                                    </div>
