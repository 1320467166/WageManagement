                            ...
                            <div class="card-body">
                                ...
                                <#if pageBean.total gt 0>
                                    <ul class="pagination ">
                                        ...
                                        <#else>
                                            <li>
                                                <a href="personage_list?year=${year!""}&currentPage=1">«</a>
                                            </li>
                                        </#if>
                                        <#list pageBean.currentShowPage as showPage>
                                            ...
                                            <#else>
                                                <li>
                                                    <a href="personage_list?year=${year!""}&currentPage=${showPage}">${showPage}</a>
                                                </li>
                                            </#if>
                                        </#list>
                                        ...
                                        <#else>
                                            <li>
                                                <a href="personage_list?year=${year!""}&currentPage=${pageBean.totalPage}">»</a>
                                            </li>
                                        </#if>
