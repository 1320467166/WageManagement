...
<head>
    ...
    <title>${siteName!""}|员工管理-编辑个人信息</title>
                        ...
                        <div class="card">
                    		...
                    		<img src="/admin/images/default-head.jpg" id="show-picture-img" alt="默认头像">
                                    ...
                                    <div class="input-group m-b-10">
                                        ...
                                        <input type="password" class="form-control required" id="edit-password" readonly
                                    ...
                                    <div class="input-group m-b-10">
                                        ...
                                        <select name="educationEnum" class="form-control selected" id="edit-educationEnum" tips="请选择学历" disabled>
                                    ...
                                    <div class="input-group m-b-10" >
                                        ...
                                        <select name="role.id" class="form-control selected" id="edit-role" tips="请选择角色" disabled>
                    	<#list roles as role>
                            <option value="${role.id}" <#if staff.role.id == role.id>selected</#if>>${role.name}</option>
                                    ...
                                    <div class="input-group m-b-10">
                                        ...
                                        <select name="jobTitle.id" class="form-control selected" id="edit-jobTitle" tips="请选择职称" disabled>
                    	...
                    	<#list jobTitleList as jobTitle>
                            <option value="${jobTitle.id}"<#if staff.jobTitle.id == jobTitle.id>selected</#if>>${jobTitle.name}</option>
                                    ...
                                    <div class="input-group m-b-10">
                                        ...
                                        <select name="position.id" class="form-control selected" id="edit-position" tips="请选择岗位" disabled>
                    	...
                    	<#list positionList as position>
                            <option value="${position.id}" <#if staff.position.id == position.id>selected</#if>>${position.name}</option>
                                    ...
                                    <div class="input-group m-b-10">
                                        ...
                                        <select name="department.id" class="form-control selected" id="edit-department" tips="请选择部门" disabled>
                            ...
                            <option value="${department.id}" <#if staff.department.id == department.id>selected</#if>>${department.name}</option>
                                    ...
                                    <div class="input-group m-b-10">
                                        ...
                                        <input type="number" class="form-control required" id="edit-salary"
                                               ...
                                               onblur="this.v();" tips="请填写基本工资" readonly="readonly"/>
                                    </div>

                                    <div class="input-group m-b-10">
                                        <span class="input-group-addon">入职时间</span>
                                        <input class="form-control required js-datepicker " tips="请选择入职时间" type="text" id="entryTime-datepicker" name="entryTime" placeholder="请选择入职时间" value="${staff.entryTime?date}" data-date-format="yyyy-mm-dd"  disabled/>
                                    </div>
