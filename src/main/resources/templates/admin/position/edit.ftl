...
<head>
    ...
    <title>${siteName!""}|岗位管理-编辑岗位</title>
        ...
        <main class="lyear-layout-content">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header"><h4>编辑岗位</h4></div>
                            <div class="card-body">
                                <form action="add" id="department-add-form" method="post" class="row">
                                    <input type="hidden" name="id" value="${position.id}">
                                    <div class="input-group m-b-10">
                                        <span class="input-group-addon">名称</span>
                                        <input type="text" class="form-control required" id="name" name="name" value="${position.name}" placeholder="请填写名称" tips="请填写名称" />
                                    </div>

                                    <div class="input-group m-b-10">
                                        <span class="input-group-addon">描述</span>
                                        <input type="text" class="form-control" id="note" name="note" value="${position.note!""}" maxlength="50"/>
                                    </div>

                                    <div class="input-group m-b-10">
                                        <span class="input-group-addon">补贴</span>
                                        <input type="number" id="subsidy" name="subsidy" value="${position.subsidy}"
