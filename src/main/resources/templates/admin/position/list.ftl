...
<head>
    ...
    <title>${siteName!""}|岗位管理-${title!""}</title>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        <#if pageBean.content?size gt 0>
                                            <#list pageBean.content as position>
                                                <tr>
                                                    <td style="vertical-align:middle;">
                                                        <label class="lyear-checkbox checkbox-primary">
                                                            <input type="checkbox" name="ids[]" value="${position.id}"><span></span>
                                                        </label>
                                                    </td>
                                                    <td style="vertical-align:middle;">${position.name}</td>
                                                    <td style="vertical-align:middle;">${position.note!""}</td>
                                                    <td style="vertical-align:middle;">${position.subsidy}</td>
                                                    <td style="vertical-align:middle;" style="vertical-align:middle;"><font class="text-success">${position.createTime}</font></td>
                                                </tr>
                                            </#list>
                                        <#else>
