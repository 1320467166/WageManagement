...
<head>
    ...
    <title>${siteName!""}|部门管理-${title!""}</title>
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-btn">
                                            <button class="btn btn-default dropdown-toggle" id="search-btn" data-toggle="dropdown" type="button" aria-haspopup="true" aria-expanded="false">
                                                部门名称 <span class="caret"></span>
                                            </button>
                                            <ul class="dropdown-menu">
                                                <li> <a tabindex="-1" href="javascript:void(0)" data-field="title">部门名称</a> </li>
                                            </ul>
                                        </div>
                                        <input type="text" class="form-control" value="${name!""}" name="name" placeholder="请输入部门名称">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        <#if pageBean.content?size gt 0>
                                            <#list pageBean.content as department>
                                                <tr>
                                                    <td style="vertical-align:middle;">
                                                        <label class="lyear-checkbox checkbox-primary">
                                                            <input type="checkbox" name="ids[]" value="${department.id}"><span></span>
                                                        </label>
                                                    </td>
                                                    <td style="vertical-align:middle;">${department.name}</td>
                                                    <td style="vertical-align:middle;">${department.note!""}</td>
                                                    <td style="vertical-align:middle;" style="vertical-align:middle;"><font class="text-success">${department.createTime}</font></td>
                                                </tr>
                                            </#list>
                                        <#else>
