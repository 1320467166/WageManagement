                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <th rowspan="2" style="text-align: center;vertical-align: middle;width: 10%">工资发放</th>
                                        </tr>
                                        <tr>
                                            ...
                                            <#list pageBean.content as salary>
                                                <tr>
                                                    ...
                                                    <td style="vertical-align:middle;text-align: center;">
                                                        <#if salary.isStatus.getCode() == 1>
                                                            <button class="btn btn-primary btn-w-md" type="button"
                                                                    onclick="send(${salary.id}, true)">发放
                                                            </button>
                                                        <#else>
                                                            <button class="btn btn-primary btn-w-md" disabled type="button">发放
                                                            </button>
                                                        </#if>
                                                    </td>
                                                </tr>
