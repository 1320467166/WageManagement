            ...
            <li class="dropdown dropdown-profile">
              <a href="javascript:void(0)" data-toggle="dropdown">
                <#if loginType == 1>
                  ...
                  <#else>
                    <img class="img-avatar img-avatar-48 m-r-10" src="/admin/images/default-head.jpg" alt="${ylrc_staff.name!""}" />
                  </#if>
                  <span>${ylrc_user.username!""} <span class="caret"></span></span>
                <#elseif loginType == 2>
                  <#if ylrc_staff.headPic??>
                    <#if ylrc_staff.headPic?length gt 0>
                      <img class="img-avatar img-avatar-48 m-r-10" src="/photo/view?filename=${ylrc_staff.headPic}" alt="${ylrc_staff.name!""}" />
                    <#else>
                      <img class="img-avatar img-avatar-48 m-r-10" src="/admin/images/default-head.jpg" alt="${ylrc_staff.name!""}" />
                    </#if>
                  <#else>
                  ...
                  <span>${ylrc_staff.name!""} <span class="caret"></span></span>
                </#if>
