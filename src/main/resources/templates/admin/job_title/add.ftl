...
<head>
    ...
    <title>${siteName!""}|职称管理-添加职称</title>
        ...
        <main class="lyear-layout-content">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header"><h4>添加职称</h4></div>
                            <div class="card-body">
                                <form action="add" id="department-add-form" method="post" class="row">
                                    <div class="input-group m-b-10">
                                        <span class="input-group-addon">职称名称</span>
                                        <input type="text" class="form-control required" id="name" name="name" value="" placeholder="请填写职称名称" tips="请填写职称名称" />
                                    </div>
